...
func MakeHandler(svc readers.MessageRepository, authn mitrasauthn.Authentication, clients grpcClientsV1.ClientsServiceClient, channels grpcChannelsV1.ChannelsServiceClient, svcName, instanceID string) http.Handler {
...
func authnAuthz(ctx context.Context, req listMessagesReq, authn mitrasauthn.Authentication, clients grpcClientsV1.ClientsServiceClient, channels grpcChannelsV1.ChannelsServiceClient) error {
...
func authenticate(ctx context.Context, req listMessagesReq, authn mitrasauthn.Authentication, clients grpcClientsV1.ClientsServiceClient) (clientID string, clientType string, err error) {
	switch {
	case req.token != "":
