...
import (
	...
	bench "github.com/hantdev/sina/tools/mqtt-bench"
...
func main() {
	...
	rootCmd.PersistentFlags().StringVarP(&bconf.Mitras.ConnFile, "mitras", "m", "connections.toml", "config file for Mitras connections")
