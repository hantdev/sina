...
import (
	...
	"github.com/hantdev/sina/pkg/errors"
	"gopkg.in/gomail.v2"
)
...
type Config struct {
	Host        string `env:"SINA_EMAIL_HOST"         envDefault:"localhost"`
	Port        string `env:"SINA_EMAIL_PORT"         envDefault:"25"`
	Username    string `env:"SINA_EMAIL_USERNAME"     envDefault:"root"`
	Password    string `env:"SINA_EMAIL_PASSWORD"     envDefault:""`
	FromAddress string `env:"SINA_EMAIL_FROM_ADDRESS" envDefault:""`
	FromName    string `env:"SINA_EMAIL_FROM_NAME"    envDefault:""`
	Template    string `env:"SINA_EMAIL_TEMPLATE"     envDefault:"email.tmpl"`
}
