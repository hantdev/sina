...
func (tm *tracingMiddleware) Add(ctx context.Context, session mitrasauthn.Session, token string, cfg bootstrap.Config) (bootstrap.Config, error) {
...
func (tm *tracingMiddleware) View(ctx context.Context, session mitrasauthn.Session, id string) (bootstrap.Config, error) {
...
func (tm *tracingMiddleware) Update(ctx context.Context, session mitrasauthn.Session, cfg bootstrap.Config) error {
...
func (tm *tracingMiddleware) UpdateCert(ctx context.Context, session mitrasauthn.Session, clientID, clientCert, clientKey, caCert string) (bootstrap.Config, error) {
...
func (tm *tracingMiddleware) UpdateConnections(ctx context.Context, session mitrasauthn.Session, token, id string, connections []string) error {
...
func (tm *tracingMiddleware) List(ctx context.Context, session mitrasauthn.Session, filter bootstrap.Filter, offset, limit uint64) (bootstrap.ConfigsPage, error) {
...
func (tm *tracingMiddleware) Remove(ctx context.Context, session mitrasauthn.Session, id string) error {
...
func (tm *tracingMiddleware) ChangeState(ctx context.Context, session mitrasauthn.Session, token, id string, state bootstrap.State) error {
