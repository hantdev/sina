...
func (mm *metricsMiddleware) Add(ctx context.Context, session mitrasauthn.Session, token string, cfg bootstrap.Config) (saved bootstrap.Config, err error) {
...
func (mm *metricsMiddleware) View(ctx context.Context, session mitrasauthn.Session, id string) (saved bootstrap.Config, err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) Update(ctx context.Context, session mitrasauthn.Session, cfg bootstrap.Config) (err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) UpdateCert(ctx context.Context, session mitrasauthn.Session, clientID, clientCert, clientKey, caCert string) (cfg bootstrap.Config, err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) UpdateConnections(ctx context.Context, session mitrasauthn.Session, token, id string, connections []string) (err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) List(ctx context.Context, session mitrasauthn.Session, filter bootstrap.Filter, offset, limit uint64) (saved bootstrap.ConfigsPage, err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) Remove(ctx context.Context, session mitrasauthn.Session, id string) (err error) {
	defer func(begin time.Time) {
...
func (mm *metricsMiddleware) ChangeState(ctx context.Context, session mitrasauthn.Session, token, id string, state bootstrap.State) (err error) {
	defer func(begin time.Time) {
