...
func (es *eventStore) Add(ctx context.Context, session mitrasauthn.Session, token string, cfg bootstrap.Config) (bootstrap.Config, error) {
...
func (es *eventStore) View(ctx context.Context, session mitrasauthn.Session, id string) (bootstrap.Config, error) {
...
func (es *eventStore) Update(ctx context.Context, session mitrasauthn.Session, cfg bootstrap.Config) error {
...
func (es eventStore) UpdateCert(ctx context.Context, session mitrasauthn.Session, clientID, clientCert, clientKey, caCert string) (bootstrap.Config, error) {
...
func (es *eventStore) UpdateConnections(ctx context.Context, session mitrasauthn.Session, token, id string, connections []string) error {
...
func (es *eventStore) List(ctx context.Context, session mitrasauthn.Session, filter bootstrap.Filter, offset, limit uint64) (bootstrap.ConfigsPage, error) {
...
func (es *eventStore) Remove(ctx context.Context, session mitrasauthn.Session, id string) error {
...
func (es *eventStore) ChangeState(ctx context.Context, session mitrasauthn.Session, token, id string, state bootstrap.State) error {
